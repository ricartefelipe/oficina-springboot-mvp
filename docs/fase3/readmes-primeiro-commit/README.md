...
Copie o arquivo correspondente para **`README.md`** na raiz de cada repositório Git antes do primeiro push.

| Repositório GitHub | Arquivo aqui |
|--------------------|---------------|
...
**PowerShell (exemplo):** na pasta do clone, após copiar o conteúdo do monorepo com `bootstrap-repos.ps1`, você pode substituir só o README:
...
Repita para os outros três nomes de arquivo e pastas.
