...
9. Pipelines: **develop** e **master** com deploy automatico conforme environments (homologacao / producao).
...
**Pipelines por branch (item 9):** workflows e script `publish-fase3-repos.ps1` no monorepo; após criar os quatro repos, usar `develop`/`master` e configurar GitHub Environments + `KUBE_CONFIG_B64` (ver [`executar-fase3.md`](executar-fase3.md)).
