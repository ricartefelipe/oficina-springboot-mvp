...
| **Linguagem ubíqua (extenso)** | Glossário detalhado com regras de negócio | [ubiquitous-language.md](ubiquitous-language.md) |
| **Event Storming** | Comandos, agregados, eventos, políticas, read models; fluxos alternativos | [event-storming.md](event-storming.md) |
| **Diagramas (Mermaid + SVG)** | Context map, agregados, sequências | [diagramas.md](diagramas.md) |
...
| Event Storming — lousa com elementos (C, A, E, P, R) | [diagrams/event-storming-lousa-elementos.svg](diagrams/event-storming-lousa-elementos.svg) |

Para **Miro**: exportar ou recriar os SVG como post-its coloridos conforme legenda em [event-storming.md](event-storming.md).
