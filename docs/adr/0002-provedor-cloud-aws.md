...
E necessario API Gateway, funcao serverless, BD gerido, Kubernetes e integracao com observabilidade. A equipe precisa de um padrao unico para o video e para a avaliacao.
